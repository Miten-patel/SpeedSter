...
namespace Yudiz.CarVR.CoreGamePlay
{
    public class CarController : MonoBehaviour
    {
        ...
        [SerializeField] private float speedRatioMultiply = 0.5f;
        ...
        private void OnEnable()
        {
            ...
            GameManager.OnRessetingMotor += ResetCarMotors;
        ...
        {
            //float speedRatio = Mathf.Abs(currentSpeed / maxSpeed) * speedRatioMultiply;
            float speedRatio = Mathf.Abs(currentmagnitude / maxSpeed);
